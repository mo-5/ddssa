...
import ZOIALibrarian as ui_main
import utilities as util
import errors
from ZOIALibrarian_bank import ZOIALibrarianBank
from ZOIALibrarian_local import ZOIALibrarianLocal
from ZOIALibrarian_ps import ZOIALibrarianPS
from ZOIALibrarian_sd import ZOIALibrarianSD
from ZOIALibrarian_util import ZOIALibrarianUtil
from api import PatchStorage
from patch_binary import PatchBinary
from patch_delete import PatchDelete
from patch_export import PatchExport
from patch_save import PatchSave
...
class ZOIALibrarianMain(QMainWindow):
    ...
    def __init__(self):
        ...
        # Message box init
        self.icon = QIcon(util.meipass("logo.ico", is_ui=True))
